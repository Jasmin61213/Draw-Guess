...
const {HGET, HGETALL, HKEYS, HVALS} = require('./model')
...
const topics = [
    ...
    '企鵝','老鷹','熊貓','穿山甲','袋鼠','洗衣機','電視','糖葫蘆','拉麵','火鍋','高速公路',
    '長頸鹿','鸚鵡','內褲','音響','安全帽','豆漿','吉他','弓箭','鯨魚','紅綠燈','斑馬線',
    '大隊接力','美人魚','雪人','馬桶','地圖','飛機','羊入虎口','鴨嘴獸泰瑞','海綿寶寶',
    '虎頭蛇尾','仙人掌','對牛彈琴','七上八下','吸血鬼','機器人','恐龍','蚊子','螢火蟲','毛毛蟲',
    '火龍果','螞蟻上樹','摩斯漢堡','櫻花','除濕機','廚師','外套','暴龍','翼手龍','衛生紙',
    '雞飛狗跳','熱氣球','暖暖包','漫畫','公主','白馬王子','睡美人','白雪公主','小矮人','神燈',
    '神社','流氓','西洋劍','魟魚','垃圾袋','垃圾車','啤酒','泡菜','煙火','牛仔褲','章魚燒',
    '炒麵麵包','麥克風','米老鼠','三眼怪','麥克華斯基','迪士尼','火箭隊','外星人','火影忍者',
    '葡萄汁','一石二鳥','手槍','鳥居','三明治','旋轉木馬','聖誕花圈','電蚊拍','鰻魚飯',
];
